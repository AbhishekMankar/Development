...
void man(char *name)
{
    ...
    {
        printf("\n Description :use to write into regular file \n");
        printf("\n Usage : write File_name \n After this enter the data that we want to writeb \n");
    }
    else if(strcmp(name,"Ls")==0)
    {
        printf("\n Description :used to list all information of the file\n");
        printf("\n Usage : Ls\n");
    }
    ...
    {
        printf("\n Description : iused to open existing file\n");
        printf("\n Usage : open file_name mode \n");
    }
    else if(strcmp(name,"close")==0)
    {
        printf("\n Description : used to close existing file \n");
        printf("\n Usage : close file_name mode \n");
    }
    else if(strcmp(name,"closeall")==0)
    {
        printf("\n Description : used to close all existing file\n");
        printf("\n Usage : closeall\n");
    }
    else if(strcmp(name,"Iseek")==0)
    {
        printf("\n Description : used to change file offset\n");
        printf("\n Usage : Iseel file_name changeInOffset Startpoint\n");
    }
...
void InitialiseSuperBlock()
{
    ...
    while(i<MAXINODE)
    {
        UFDTArr[i].ptrfiletable=NULL;     // used to set all values null // it is for safety
        i++;
    }
...
int CreateFile(char *name,int permission)
{
    ...
    while(temp!=NULL)    // used to find empty inode
    {
        if(temp->Filetype==0)
            break;
        temp=temp->next;    
    ...
    while(i<50)         // used to find empty UFDTArr
    {
        if(UFDTArr[i].ptrfiletable==NULL)
            break;
        i++;    
...
int main()
{
    ...
    while(1)  // unconditional loop  // it is shell.
    {
        fflush(stdin);
        strcpy(str,"");   // used to clear string //it is good sign to clear everytime
        ...
        if(count==1)
        {
            ...
            {
                printf("Terminating the Abhishek virtual file system\n");
                break;
            }
            else
            {
        ...
        else if(count==3)
        {
            ...
            else if(strcmp(command[0],"read")==0)
            {
                ...
                if(ret==-2)
                    printf("ERROR : Permission denied \n");
                if(ret==-3)
                    printf("ERROR : reaached at end of file \n");
                if(ret==-4)
                    printf("ERROR : it is not regular file \n");
                if(ret==0)
